...
type ComplexityRoot struct {
	Mutation struct {
		AddUser    func(childComplexity int, name string, email string, age int, bio *string) int
		DeleteUser func(childComplexity int, id int) int
		UpdateUser func(childComplexity int, id int, name *string, email *string, age *int, bio *string) int
	}
...
type MutationResolver interface {
	AddUser(ctx context.Context, name string, email string, age int, bio *string) (*model.User, error)
	UpdateUser(ctx context.Context, id int, name *string, email *string, age *int, bio *string) (*model.User, error)
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.addUser":
		...
		return e.complexity.Mutation.AddUser(childComplexity, args["name"].(string), args["email"].(string), args["age"].(int), args["bio"].(*string)), true
	...
	case "Mutation.updateUser":
		...
		return e.complexity.Mutation.UpdateUser(childComplexity, args["id"].(int), args["name"].(*string), args["email"].(*string), args["age"].(*int), args["bio"].(*string)), true
...
func (ec *executionContext) _Mutation_addUser(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().AddUser(rctx, fc.Args["name"].(string), fc.Args["email"].(string), fc.Args["age"].(int), fc.Args["bio"].(*string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalOUser2ᚖgithubᚗcomᚋShueheiYoshidaJPᚋgo_flutter_sample_appᚋgraphᚋmodelᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_updateUser(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateUser(rctx, fc.Args["id"].(int), fc.Args["name"].(*string), fc.Args["email"].(*string), fc.Args["age"].(*int), fc.Args["bio"].(*string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_listUsers(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.User)
	fc.Result = res
	return ec.marshalOUser2ᚕᚖgithubᚗcomᚋShueheiYoshidaJPᚋgo_flutter_sample_appᚋgraphᚋmodelᚐUser(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOUser2ᚕᚖgithubᚗcomᚋShueheiYoshidaJPᚋgo_flutter_sample_appᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v []*model.User) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalOUser2ᚖgithubᚗcomᚋShueheiYoshidaJPᚋgo_flutter_sample_appᚋgraphᚋmodelᚐUser(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalOUser2ᚖgithubᚗcomᚋShueheiYoshidaJPᚋgo_flutter_sample_appᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v *model.User) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
